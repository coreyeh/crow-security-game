    ...
    <div className="grid place-items-center h-full">
      <main className="space-y-6 max-w-80 w-full">
        <header className="flex flex-col items-center gap-4">
          ...
          <h3 className="font-header text-2xl">Sign in to Grey Layer</h3>
        </header>
        <form className="space-y-6">
          ...
          <PasswordInput.Root className="flex flex-col gap-2 w-full"> 
            <div className="flex items-center justify-between">
              ...
              <Link to="/recover" className="text-sm text-light hover:underline">Forgot your password?</Link>
            </div>
        ...
        <div className="flex items-center justify-center gap-2 text-mid text-sm">
          ...
          <Link to='/register' className="flex items-center gap-1 text-lightest hover:text-light">
            Sign up 
